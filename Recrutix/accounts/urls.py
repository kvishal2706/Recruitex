...
from .views import SignUpView, delete_qualification, delete_workExperience,index,about_us,contact_us,profiles_list, search_profile,subscribe,newsletter,profile_page,home, update_qualifications, update_workExperience
...
urlpatterns = [
    ...
    path('profiles/<str:username>', search_profile, name = 'search-profile'),
